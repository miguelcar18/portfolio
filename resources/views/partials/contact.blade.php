...
<section id="contacto" class="section">
    <div class="container">
        <div class="contact-box">
            ...
            <a href="mailto:tu-correo@example.com" class="button button-primary" data-i18n="contact.button">Hablemos
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M4 4h16v16H4z"></path>
                    <path d="m4 7 8 5 8-5"></path>
                </svg>
            </a>
            <a href="mailto:tu-correo@example.com" class="contact-email">tu-correo@example.com</a>
        </div>
    </div>
</section>