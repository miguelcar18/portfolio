...
const projects = [
    ...
    },
    {
        ...
        description: "Aplicación web para gestionar información, procesos internos y operaciones relacionadas con clientes y sistemas.",
    ...
    },
    {
        ...
        description: "Middleware desarrollado para obtener información desde diferentes servicios y centralizarla en una aplicación Laravel.",
    ...
    },
    {
        ...
        description: "Configuración y mantenimiento de entornos de desarrollo utilizando Docker, Laravel y diferentes servicios auxiliares.",
    ...
    },
    {
        ...
        description: "Procesamiento, actualización y sincronización de grandes cantidades de registros utilizando Laravel y bases de datos SQL.",
    ...
    },
    {
        ...
        description: "Interfaz para visualizar información obtenida desde diferentes servicios y APIs externas.",
...
const translations = {
    es: {
        ...
        "about.description": "Mi experiencia está principalmente enfocada en aplicaciones web existentes, mantenimiento, resolución de problemas e integración de sistemas.",
        "about.highlight": "Durante los últimos años he trabajado principalmente con PHP y Laravel, participando en aplicaciones que necesitan conectarse con APIs externas, marketplaces, bases de datos y otros sistemas.",
        "about.cardTitle": "Mi enfoque",
        ...
        "projects.description": "Una selección de aplicaciones, integraciones, APIs y herramientas desarrolladas o mantenidas.",

        "filters.all": "Todos",
        "filters.database": "Base de datos",
        ...
        "services.item3.title": "APIs e integraciones",
        "services.item3.text": "Integración con APIs externas y comunicación entre diferentes sistemas.",

        "contact.title": "¿Tienes un proyecto o una oportunidad?",
        "contact.description": "Si buscas alguien que pueda trabajar sobre una aplicación existente, resolver problemas o desarrollar nuevas funcionalidades con PHP y Laravel, podemos hablar.",
    ...
    en: {
        ...
        "about.description": "My experience is mainly focused on existing web applications, maintenance, troubleshooting and system integrations.",
        "about.highlight": "Over the last few years I have mainly worked with PHP and Laravel, participating in applications that connect with external APIs, marketplaces, databases and other systems.",
        "about.cardTitle": "My approach",
        ...
        "projects.description": "A selection of applications, integrations, APIs and tools developed or maintained.",

        "filters.all": "All",
        "filters.database": "Database",

        "projects.loadMore": "View more",
        ...
        "services.item3.text": "Integration with external APIs and communication between different systems.",

        "contact.title": "Have a project or an opportunity?",
        "contact.description": "If you are looking for someone who can work on an existing application, solve problems or develop new functionality with PHP and Laravel, let's talk.",
...
function renderProjects() {
    ...
    if (filtered.length <= 2 && visibleCount <= 2) {
        resetProjectsButton.style.display = activeFilter === "all" ? "none" : "inline-flex";
    } else {
        resetProjectsButton.style.display = "inline-flex";
    }
}
